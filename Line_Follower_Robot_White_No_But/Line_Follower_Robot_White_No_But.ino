...
void White_Line_Following()
{
    ...
    //    Run_Straight();
    //}
    if (V_S1 == 1 && V_S2 == 0 && V_S3 == 0 && V_S4 == 0 && V_S5 == 1 && Turning == 0)     // 1-0-0-0-1
    {
        Turn_check = 0;
        Run_Straight();
    }
    ...
    //Turning
    if (V_S1 == 0 && V_S2 == 0 && V_S3 == 1 && V_S4 == 1 && V_S5 == 1 && Turn_check == 1   // 0-0-1-1-1 
    ...
    if (V_S1 == 1 && V_S2 == 1 && V_S3 == 1 && V_S4 == 0 && V_S5 == 0 && Turn_check == 1 // 1-1-1-0-0
